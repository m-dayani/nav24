...
class TrackerMS(Tracker):
    ...
    def init(self, frame, bbox):
        ...
        bbox_int = Tracker.detect_roi(frame, bbox_int)

        (x, y, w, h) = bbox_int
        track_window = bbox_int
    ...
    def update(self, frame):
        ...
        track_window = (self.track_window[0], self.track_window[1], self.track_window[2], self.track_window[3])
...
if __name__ == '__main__':
    ...
    # ttest_tracker_cv(os.path.join(data_dir, 'aun-lab'))
    ttest_mean_shift(data_dir)
    # ttest_cam_shift(data_dir)
