...
public:
    ...
    NAV24::GeometricCamera* pCamera1, *pCamera2;
...
// You'll get runtime exception (Segmentation fault) if instantiate the g2o type directly
    ...
    public:
        ...
        void oplusImpl(const double *update_) override {
            VertexSE3Expmap::oplusImpl(update_);
        }
    };

    class MyVertexSBAPointXYZ : public g2o::VertexSBAPointXYZ {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        void oplusImpl(const double *update) override {
            VertexSBAPointXYZ::oplusImpl(update);
        }
    };
